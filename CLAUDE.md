...
- **PDF αναφοράς** (§Λοιπές 3): προσχέδιο στο `docs/report.html` — 11 κεφάλαια,
  κατά τη ζητούμενη δομή. Άνοιγμα στον browser → Ctrl+P → «Αποθήκευση ως PDF».
  **Λείπουν τα ονόματα και οι ΑΜ** (κίτρινα πεδία στο εξώφυλλο και στο §1.2).
