...
def create_booking(
    ...
    # Εκφώνηση §9: κρατήσεις «όταν η εκδήλωση είναι ενεργή». Μια δημοσιευμένη
    # εκδήλωση που έχει ήδη ξεκινήσει δεν είναι πια ενεργή για κρατήσεις, ακόμη κι
    # αν κανείς δεν άλλαξε την κατάστασή της. Οι ώρες στη βάση είναι naive UTC.
